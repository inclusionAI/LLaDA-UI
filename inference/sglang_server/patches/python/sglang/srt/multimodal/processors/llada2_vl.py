...
from sglang.srt.models.llada2_vl import LLaDA2MoE_VLForConditionalGeneration
...
class LLaDA2MoE_VLImageProcessor(SGLangBaseProcessor):
    models = [
    ...
    async def process_mm_data_async(
        ...
        **kwargs,
        ...
        logger.debug(
            f"[LLaDA2MoE_VLProcessor Perf] {rid=}, "
